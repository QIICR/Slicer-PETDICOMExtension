...
struct parameters
  {
    ...
    double patientHeight; //in centimeters
...
//            this->Day = 0;
      ...
      //---
      //--- PatientSex
      if(fileReader.GetElementCS(0x0010,0x0040,list.patientSex,false) == EXIT_SUCCESS)
        {
      ...
      if(fileReader.GetElementCS(0x0028,0x0051,correctedImage,false) == EXIT_SUCCESS)
        {
        std::cout << "Corrected Image: " << correctedImage << std::endl;
        }
      //else
      //  {
      //  list.patientSex = "MODULE_INIT_NO_VALUE";
  ...
  double height = list.patientHeight;
